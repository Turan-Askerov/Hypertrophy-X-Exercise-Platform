...
POSTGRES_SCHEMA_STATEMENTS = (
    ...
    "ALTER TABLE athlete_profiles ADD COLUMN IF NOT EXISTS email TEXT NOT NULL DEFAULT ''",
    """
    ...
    "CREATE INDEX IF NOT EXISTS idx_password_resets_verified ON password_resets (verified_token)",
    """
